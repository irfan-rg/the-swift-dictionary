  ...
  if (success) {
    return (
      <div className="flex items-center justify-center min-h-[70vh] px-4">
        <div className="w-full max-w-md rounded-2xl border border-neutral-200 dark:border-neutral-800 bg-white/60 dark:bg-neutral-900/40 backdrop-blur p-8 text-center">
          <div className="w-14 h-14 rounded-full bg-green-100 dark:bg-green-900/30 grid place-items-center mx-auto mb-4">
            <Mail className="w-6 h-6 text-green-600" />
          </div>
          <h2 className="font-playfair text-2xl font-bold text-neutral-900 dark:text-white mb-2">
            Check your email
          </h2>
          ...
          <Link
            href="/auth/login"
            className="font-medium link-accent text-sm"
          >
            Back to login
          </Link>
        </div>
    ...
    <div className="flex items-center justify-center min-h-[70vh] px-4">
      <div className="w-full max-w-md rounded-2xl border border-neutral-200 dark:border-neutral-800 bg-white/60 dark:bg-neutral-900/40 backdrop-blur p-8">
        ...
        <p className="mt-6 text-center text-sm text-neutral-600 dark:text-neutral-400">
          ...
          <Link href="/auth/login" className="font-medium link-accent">
            Sign in
          </Link>
        </p>
      </div>
