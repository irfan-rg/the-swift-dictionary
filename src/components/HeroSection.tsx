      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 min-h-[85vh] md:min-h-screen flex items-center">
        <div className="text-center w-full">
          <motion.div
            ...
            className="mb-8"
          >
            <div className="inline-flex items-center space-x-2 rounded-full px-6 py-2 mb-6 border border-neutral-200 dark:border-neutral-800 bg-white/60 dark:bg-neutral-900/40 backdrop-blur">
            ...
            <h1 className="font-playfair text-5xl md:text-7xl font-bold mb-6 text-neutral-900 dark:text-white">
            ...
            <p className="text-lg md:text-xl text-neutral-600 dark:text-neutral-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              ...
              From <em className="text-violet-600 font-semibold dark:text-violet-400">serendipitous</em> to <em className="text-cyan-600 font-semibold dark:text-cyan-400">ephemeral</em>, 
          ...
          >
            <Link
              href="/dictionary"
              className="group inline-flex items-center space-x-2 px-8 py-4 rounded-full font-semibold text-lg text-white bg-neutral-900 dark:bg-white dark:text-neutral-900 shadow-sm hover:shadow-md transform hover:-translate-y-0.5 transition-all duration-300"
            >
            ...
            <Link
              href="/explorer"
              className="group inline-flex items-center space-x-2 px-8 py-4 rounded-full font-semibold text-lg border border-neutral-300 dark:border-neutral-700 text-neutral-800 dark:text-neutral-200 hover:-translate-y-0.5 transition-all duration-300"
            >
