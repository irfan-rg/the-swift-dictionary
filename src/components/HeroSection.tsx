    ...
    <section className="relative w-full min-h-[calc(100vh-3.5rem)] flex flex-col items-center px-4">
      ...
      <div className="flex flex-col items-center text-center">
        ...
        <motion.p
          ...
          className="font-handwriting text-2xl md:text-3xl lg:text-4xl text-[var(--accent)] mb-6 md:mb-8"
        >
        ...
        <motion.h1
          ...
          className="font-display text-6xl sm:text-7xl md:text-8xl lg:text-[7rem] font-medium leading-[0.9] tracking-tight mb-10 md:mb-14"
        >
          The Swift<br />
        ...
        <motion.p
          ...
          className="font-body text-base md:text-lg max-w-xl text-[var(--foreground-muted)] font-light leading-relaxed"
        >
        ...
        <div className="marquee-track">
          {doubled.map((era, i) => (
            <Link
              ...
              style={{
                '--era-color': isDark ? era.colorDark : era.color,
              } as React.CSSProperties}
            >
              <span className="marquee-dot" style={{ backgroundColor: isDark ? era.colorDark : era.color }} />
